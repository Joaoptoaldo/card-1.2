...
function setTheme(index) {
  // Remove todos e adiciona o novo
        ...
        surpriseBtn.addEventListener('click', function() {
            ...
            if (message) {
                const messages = [
                    ...
                    "Você é minha inspiração diária, meu apoio e minha alegria!",
                    "Sempre vou agradecer por sermos nós, juntos, nessa vida",
                    "É impossível não sorrir quando vejo com você",
...
if (abrirFotoBtn) {
  abrirFotoBtn.addEventListener('click', () => {
    fotoPopup.classList.remove('hidden');
  });
}
...
fotoPopup.addEventListener('click', (e) => {
  if (e.target === fotoPopup) {
    fotoPopup.classList.add('hidden');
  }
});
